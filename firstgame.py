...
# score_surf = test_font.render('TryHard', False, (64, 64, 64)).convert()
...
game_title = test_font.render('TryHard', False, 'black').convert()
game_title_rect = game_title.get_rect(center=(400, 40))

instruction_text = test_font.render(
    'Press the spacebar to play the game!', False, 'Black').convert()
instruction_text_rect = instruction_text.get_rect(center=(400, 325))
